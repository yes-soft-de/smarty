...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __( 'New User profile slug', 'simple-jwt-login' ); ?></h3>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            <p><?php echo __( 'These properties can be passed in the request when the new user is created.',
					'simple-jwt-login' ); ?></p>
