...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __( 'JWT Login Settings', 'simple-jwt-login' ); ?></h3>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __( 'Redirect after Auto-Login', 'simple-jwt-login' ); ?></h3>
        <div class="form-group">
