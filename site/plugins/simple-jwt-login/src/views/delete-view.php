...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __( 'Allow Delete', 'simple-jwt-login' ); ?></h3>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div id="require_delete_auth_alert" class="alert alert-warning" role="alert"
				...
				<?php echo __( " Warning! It's not recommended to allow delete users without Auth Codes",
					'simple-jwt-login' ); ?>.
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __( 'JWT Delete User Config', 'simple-jwt-login' ); ?></h3>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="row">
    <div class="col-md-12">
        <h3 class="section-title"><?php echo __( 'Allow Delete user only from the following IP addresses',
				'simple-jwt-login' ); ?>:</h3>
        <div class="form-group">
            <input type="text" id="delete_ip" name="delete_ip" class="form-control"
                   value="<?php echo $jwtSettings->getAllowedDeleteIps(); ?>"
