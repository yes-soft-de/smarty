//VideoWhisper.com WebRTC implemetation / 2020.06.22
let startTime;
...
function onIceGatheringState()
{
    ...
    jQuery("#sdpDataTag").html('iceGatheringState: ' + peerConnection.iceGatheringState);
    
    	if (peerConnection.iceGatheringState == 'gathering') hasCandidate = true;
    	if (hasGotDescription) serverPlay();
  	}
}
...
function onSignalingStateChange()  //
{
  ...
  if (peerConnection) {
    ...
    jQuery("#sdpDataTag").html('signalingState: ' + peerConnection.signalingState);
  }
}
...
function onIceStateChange(pc, event) {
  ...
  if (pc) {
    ...
    console.log('onIceStateChange event: ', event);
     ...
     jQuery("#sdpDataTag").html('WebRTC peer connnection: ' + iceState);
