...
<param name="movie" value="<?php echo $swfurl?>"></param><param bgcolor="<?php echo $bgcolor?>"><param name="scale" value="noscale" /> </param><param name="salign" value="lt"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed width="100%" height="100%" scale="noscale" salign="lt" src="<?php echo $swfurl?>" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" bgcolor="<?php echo $bgcolor?>"></embed>
</object>
<style type="text/css">
<!--
BODY
