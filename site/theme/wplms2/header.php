...
<div id="global" class="global">
    ...
    <div class="pusher">
        ...
        <header class="<?php if(is_front_page()): ?> custom-header <?php endif; ?> top">
            <div class="<?php echo vibe_get_container(); ?>">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-4">
                        <?php
                            ...
                            if(!empty($url)){
                        ?>
                            <a href="<?php echo vibe_site_url(); ?>"><img src="<?php  echo get_template_directory_uri() . '/assets/img/Logo.png'; ?>" width="100" height="48" alt="<?php echo get_bloginfo('name'); ?>" /></a>
                        <?php
                            }
                            if(is_front_page()){
                                echo '</h1>';
