            ...
            <div class="col-12">
              ...
              <div class="col-12 col-md-8">
                <div class="live-video-desc">
                  ...
                  <div class="w-75 register-button">
<!--                    <a href="--><?php //echo get_site_url() . '/register' ?><!--">Register now</a>-->
              ...
              <div class="col-md-4 d-none d-md-block align-self-center text-center">
                <img class="live-video-image flashOpacity" src="<?php echo get_template_directory_uri() . '/img/home-slider-circle.png' ?>" alt="home slider circle">
              </div>
            </div>
          </div>
        <?php endwhile; ?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="d-none d-sm-block col-sm-4 col-md-6 align-self-center text-center mb-5">
          <img class="video-player-icon" src="<?php echo get_template_directory_uri() . '/img/purple-card.png' ?>" alt="">
        </div>
        <div class="col-12 col-md-4">
          <div class="content-icon-item">
            <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/react.png'; ?>" alt="react image">
          </div>
        ...
        <div class="col-12 col-md-4">
          <div class="content-icon-item">
            <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/balance.png'; ?>" alt="balance image">
          </div>
          <h5>Give advice</h5>
          <p class="content-small-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis facilis obcaecati reprehenderit?</p>
        </div>
        <div class="col-12 col-md-4">
          <div class="content-icon-item">
            <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/brain.png'; ?>" alt="brain image">
          </div>
                ...
                <div class="col-9">
                  <div class="content-box">
                    <div class="col-9 content-top">
                      ...
                      <h3 class="my-3"><?php echo get_the_title(); ?></h3>
  ...
  <article class="our-services">
    <div class="col-12 col-sm-10 col-md-10 mx-auto">
      ...
      <h3 class="text-center my-4">Our Services</h3>
      <p class="col-12 col-sm-10 col-md-8 col-lg-5 mx-auto text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet culpa deleniti eligendi esse expedita</p>
      <div class="row">
            ...
            <div class="row">
              <div class="col-6 mb-4">
                <div class="service-box">
                  <div class="content-icon-item">
                    <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/billiard-without-border.png'; ?>" alt="brain image">
                  </div>
              ...
              <div class="col-6">
                <div class="content-icon-item">
                  <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/react-without-border.png'; ?>" alt="brain image">
                </div>
              ...
              <div class="col-6">
                <div class="content-icon-item">
                  <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/brain-without-border.png'; ?>" alt="brain image">
                </div>
              ...
              <div class="col-6">
                <div class="content-icon-item">
                  <img class="responsive-image" src="<?php echo get_template_directory_uri() . '/img/chess-without-border.png'; ?>" alt="brain image">
                </div>
        ...
        <div class="col-12 col-sm-4 volunteer-group pt-4 pb-5">
          <img src="<?php echo get_template_directory_uri() . '/img/inner-peace-meditation.jpg'; ?>" class="responsive-image" alt="volunteer group image">
...
//	              { return; }
                  ?>
                <div class="meditation-video <?php echo $lesson->is_free() ? 'freeLesson' : ''; ?> p-4 mb-3">
          ...
          <?php $x++; endif; endforeach; endwhile; ?>

        </div><!--.container-->
        <div class="w-50 full-sessions">
...
//      $args =	get_terms( 'course_cat', array( 'hide_empty' => 0 ));
      $query = new WP_Query( $args );
      if ( $query->have_posts() ): ?>
              ...
              <?php while ( $query->have_posts() ):
                ...
                <div class="col-4">
                  <div class="courses-box">
                    <div class="card">
                      <img class="card-img-top p-3" src="<?php echo get_the_post_thumbnail_url();  ?>" alt="Card image cap">
                      <div class="card-body">
