...
final List<MeditationSuggestions> imgList = [
   MeditationSuggestions(title:'Weelky Progress', content:'erhr frgredg c dfbdfh dhgh  hdgh xge t', image: 'assets/BG.png'),
   MeditationSuggestions(title:'bla bla', content:'shshrehe rher theth gh  h rh', image: 'assets/BG2.jpg'),
   MeditationSuggestions(title:'go go', content:'zcbvsf gh tt ghg   gfhfg  fghg  ur yt', image: 'assets/BG3.jpg'),
...
class _MeditationPageState extends State<MeditationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SmartyAppBar(appBar: AppBar(),title: 'Meditattion', ),
      drawer: AppDrawer(),
        ...
        child: Column(
           ...
           children: <Widget>[
             ...
             Row(
               ...
               children: <Widget>[
                 Text('Mindfulness Plan',style: TextStyle(color: Colors.black87,fontSize: 12),),
                 Text('10 Audios',style: TextStyle(color: Colors.black87,fontSize: 12),),
               ],
             ),
             Container(
               padding: EdgeInsetsDirectional.fromSTEB(0, 10, 0, 10),
               width: MediaQuery.of(context).size.width*0.8,
               child: Text('aaa aaaaa aaaa aaaaaaa aaaaaaaaaaaaa aaaaaaaaa aaaaa aaaaa aa'),
             ),
             Row(
               mainAxisAlignment: MainAxisAlignment.spaceEvenly,
               children: <Widget>[
                 ...
                 Text('Edit',style: TextStyle(color:  Color(0xff5E239D)),),
               ],
             ),
             VideoCard(
