...
class MeditationDetailsPage extends StatefulWidget {
  ...
  MeditationDetailsPage(this._appDrawerWidget, this._meditationDetailsBloc,
      this._logger, this._playerService);
  ...
  Widget build(BuildContext context) {
    ...
    widget._meditationDetailsBloc.meditationDetailsStateObservable
      ...
      if (currentState ==
        ...
        this._meditationDetails.audios.insert(0, new Audio(name: ''));
      }
