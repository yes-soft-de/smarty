...
import '../../module_chat/bloc/chat_page/chat_page.bloc.dart' as _i52;
import '../../module_chat/service/chat/char_service.dart' as _i53;
import '../../module_chat/manager/chat/chat_manager.dart' as _i54;
import '../../module_chat/repository/chat/chat_repository.dart' as _i55;
import '../../meditation/Meditation_module.dart' as _i56;
...
class AppComponent$Injector implements _i1.AppComponent {
  ...
  _i46.ProgramDetailsPage _createProgramDetailsPage() =>
      _i46.ProgramDetailsPage(
          _createProgramDetailsPageBloc(), _createLogger(), _createChatPage());
  ...
  _i53.ChatService _createChatService() =>
      _i53.ChatService(_createChatManager(), _createSharedPreferencesHelper());
  _i54.ChatManager _createChatManager() =>
      _i54.ChatManager(_createChatRepository());
  _i55.ChatRepository _createChatRepository() => _i55.ChatRepository();
  _i56.MeditationModule _createMeditationModule() => _i56.MeditationModule(
      _createMeditationDetailsPage(),
      _createMeditationPage(),
      _createMeditationSettingPage());
  _i57.MeditationDetailsPage _createMeditationDetailsPage() =>
      _i57.MeditationDetailsPage(
          _createAppDrawerWidget(),
          _createMeditationDetailsBloc(),
          _createLogger(),
          _createAudioPlayerService());
  _i58.MeditationDetailsBloc _createMeditationDetailsBloc() =>
      _i58.MeditationDetailsBloc(
          _createLogger(), _createMeditationDetailsService());
  _i59.MeditationDetailsService _createMeditationDetailsService() =>
      _i59.MeditationDetailsService(_createMeditationDetailManager());
  _i60.MeditationDetailManager _createMeditationDetailManager() =>
      _i60.MeditationDetailManager(_createMeditationDetailsRepository());
  _i61.MeditationDetailsRepository _createMeditationDetailsRepository() =>
      _i61.MeditationDetailsRepository(
          _createApiClient(), _createSharedPreferencesHelper());
  _i62.MeditationPage _createMeditationPage() => _i62.MeditationPage(
      _createMeditationPageBloc(),
      _createLogger(),
      _createSharedPreferencesHelper());
  _i63.MeditationPageBloc _createMeditationPageBloc() =>
      _i63.MeditationPageBloc(_createMeditationService(), _createLogger());
  _i64.MeditationService _createMeditationService() =>
      _i64.MeditationService(_createMeditationManager());
  _i65.MeditationManager _createMeditationManager() =>
      _i65.MeditationManager(_createMeditationRepository());
  _i66.MeditationRepository _createMeditationRepository() =>
      _i66.MeditationRepository(_createApiClient());
  _i67.MeditationSettingPage _createMeditationSettingPage() =>
      _i67.MeditationSettingPage(_createSharedPreferencesHelper());
  @override
